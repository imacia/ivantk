...
# Example invocation:
#
#  MIST_DEPENDENT_OPTION(USE_FOO "Use Foo" ON "USE_BAR;USE_ZOT" OFF)
#
...
#
MACRO( IVAN_DEPENDENT_OPTION option doc default depends force )
...
ENDMACRO( IVAN_DEPENDENT_OPTION)
...
MACRO( FIND_HHC_LOCATION )
	...
	FIND_PROGRAM( HHC_LOCATION 
    NAMES hhc
    PATHS "$ENV{ProgramFiles}/HTML Help Workshop" "$ENV{ProgramFiles(x86)}/HTML Help Workshop"
  )
  
ENDMACRO( FIND_HHC_LOCATION )
